# 🇧🇷 SolidSign API - Exemplo de Integração: Assinatura CAdES (CMS) com PKCS#12 (certificado pré-importado) (Node.js (Fastify))
...
O serviço sobe em `http://localhost:3091`.
...
# 🇬🇧 SolidSign API - Integration Example: CAdES (CMS) Signing with PKCS#12 (pre-imported certificate) (Node.js (Fastify))
...
The service starts on `http://localhost:3091`.
